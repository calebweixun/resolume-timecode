...
- Latest release tag: `v1.0.6` at commit `fb176d8`.
- Release Action run `28313105264` completed successfully.
- The `v1.0.6` GitHub Release exists as a draft with macOS Universal, Windows
