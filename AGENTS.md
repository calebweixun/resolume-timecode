...
- Latest release tag: `v1.0.5` at commit `2f6aa1f`.
- Release Action run `28312373994` completed successfully.
- The `v1.0.5` GitHub Release exists as a draft with macOS Universal, Windows
